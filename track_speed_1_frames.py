            ...
            if det is not None and len(det):
                ...
                if len(outputs[i]) > 0:
                    ...
                    for j, (output, conf) in enumerate(zip(outputs[i], confs)):
                        ...
                        if id in d:
                            speed = calculate_speed(d[id], [bbox_left, bbox_top], 30.045,(567.06/10))
                            d[id] = [bbox_left, bbox_top, round(speed,2)]
                            
                        else:
                            d[id] = [bbox_left, bbox_top]
